...
public class VillagerNextRestockTimeInfo {
    public static Component getInfo(@NotNull Villager villager) {
        ...
        long nextWorkTime;
        long timeOfDay = villager.level().getDefaultClockTime() % 24000;
        ...
        MerchantOffers offers = VillagerDataUtil.getOffers(villager);
        ...
        if (needsRestock(villager, offers)) {
    ...
    private static boolean needsRestock(@NotNull Villager villager, @NotNull MerchantOffers offers) {
